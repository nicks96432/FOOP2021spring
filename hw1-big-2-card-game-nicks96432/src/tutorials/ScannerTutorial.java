...
public class ScannerTutorial {
	private final static String input = "1 2 3\n" + "aa bb cc\n" + "line1\n" + "line2";

	// Typically you should use `new Scanner(System.in)` to consume from the
	// standard input,
	// However, in this tutorial, we directly feed the 'input' String into the
	// Scanner.
